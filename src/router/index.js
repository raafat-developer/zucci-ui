...
const routes = [
  ...
  // ── Admin console (protected: authenticated + admin role) ──
  {
    ...
    children: [
      ...
      { path: 'warehouses/inventory', name: 'warehouses/inventory', component: () => import('@/views/admin/warehouses/subviews/InventoryMasterView.vue'), meta: { title: 'Inventory' } },
      { path: 'warehouses/finance', name: 'warehouses/finance', component: () => import('@/views/admin/warehouses/subviews/FinanceSummaryView.vue'), meta: { title: 'Finance Summary' } },
      { path: 'warehouses/aging', name: 'warehouses/aging', component: () => import('@/views/admin/warehouses/subviews/AgingDashboardView.vue'), meta: { title: 'Aging Dashboard' } },
      { path: 'warehouses/inbound', name: 'warehouses/inbound', component: () => import('@/views/admin/warehouses/subviews/InboundShipmentsView.vue'), meta: { title: 'Inbound Shipments' } },
      { path: 'warehouses/returns', name: 'warehouses/returns', component: () => import('@/views/admin/warehouses/subviews/ReturnsQueueView.vue'), meta: { title: 'Returns Queue' } },
      { path: 'warehouses/transfers', name: 'warehouses/transfers', component: () => import('@/views/admin/warehouses/subviews/TransfersHubView.vue'), meta: { title: 'Transfers Hub' } },
