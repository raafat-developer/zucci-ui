<template>
  <div class="zp-filters">
    ...
    <select
      ...
      @change="updateFilter('vendor', $event.target.value)"
    >
    ...
    <select
      ...
      @change="updateFilter('market', $event.target.value)"
    >
      <option value="all">All Markets</option>
      <option v-for="market in markets" :key="market" :value="market.id">
        {{ market.code }}
      </option>
    </select>
    ...
    <select
      ...
      @change="updateFilter('approval', $event.target.value)"
    >
