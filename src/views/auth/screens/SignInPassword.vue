  ...
  <form @submit.prevent="onNext" style="display: contents">
    <div class="zauth-fields">
      <div class="zauth-field">
        <label class="zauth-label"> Password </label>
        <ZInput
          v-model="pw"
    ...
    <div class="zauth-btn-row">
      <ZButton variant="ghost" type="button" @click="$emit('back')"
        >Back</ZButton
      >
      <ZButton variant="primary" full type="submit" :disabled="auth.loading">
