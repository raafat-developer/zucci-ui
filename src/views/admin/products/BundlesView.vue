  ...
  <div class="zcat-wrap">
    ...
    <div class="zwh-header">
      <div class="zwh-header-left">
        ...
        <div class="zwh-subtitle">
          Configure multi-item catalog packages, B2B wholesale pricing levels,
          and retail partner credit limits
        </div>
      </div>
      <div class="zwh-header-right">
        ...
        >
          <button
            class="mode-btn"
            :class="{ 'is-active': activeModuleTab === 'bundles' }"
            @click="activeModuleTab = 'bundles'"
            style="
              padding: 4px 12px;
              border-radius: 4px;
              border: none;
          ...
          <button
            class="mode-btn"
            :class="{ 'is-active': activeModuleTab === 'b2b_accounts' }"
            @click="activeModuleTab = 'b2b_accounts'"
            style="
              padding: 4px 12px;
              border-radius: 4px;
              border: none;
          ...
          <button
            class="mode-btn"
            :class="{ 'is-active': activeModuleTab === 'b2b_prices' }"
            @click="activeModuleTab = 'b2b_prices'"
            style="
              padding: 4px 12px;
              border-radius: 4px;
              border: none;
        ...
        <!-- <button
          v-if="activeModuleTab === 'b2b_accounts'"
          class="zwh-btn-primary"
          @click="b2bFormOpen = true"
        >
          + Add Account
        </button> -->
      </div>
    ...
    <div class="zwh-kpi-strip">
      ...
      <div class="zwh-kpi-cell">
        ...
        <span class="zwh-kpi-val is-good">{{
      ...
      <div class="zwh-kpi-cell">
        ...
        <span class="zwh-kpi-val is-accent">{{
    ...
    <div class="zcat-content" style="overflow-y: auto">
        ...
        <div style="display: flex; flex-direction: column; gap: 8px">
          <div
            ...
            style="
              ...
              padding: 14px 16px;
              display: grid;
              grid-template-columns: 1.5fr 1fr 100px 80px 80px 100px 120px;
              gap: 10px;
              align-items: center;
            "
          >
            ...
            >
            <span
              style="font-family: var(--zg-mono); font-size: 12px"
              :class="
                b.stock < 10
            ...
            <div style="display: flex; gap: 4px">
              ...
              <button class="zcat-act" @click="toggleBundleStatus(b)">
      ...
      >
        <div
          style="
            display: grid;
            grid-template-columns: 80px 1.5fr 1fr 80px 1fr 1fr 80px 100px;
            gap: 10px;
            padding: 10px 14px;
            background: var(--zg-panel-hi);
        ...
        >
          ...
          >
          <div>
            <div style="font-weight: 700; color: var(--zg-text)">
              {{ c.name }}
            </div>
            <div
              style="font-size: 10.5px; font-weight: 700; margin-top: 2px"
              :style="{
                color:
                  c.status === 'active' ? 'var(--zg-good)' : 'var(--zg-warn)',
              }"
            >
          ...
          <span
            ...
            >{{ c.market }}</span
          >
          <span style="font-family: var(--zg-mono)"
            >AED {{ c.creditLimit.toLocaleString() }}</span
          >
          <span
            style="font-family: var(--zg-mono)"
            :style="{
              color:
                c.outstanding > c.creditLimit * 0.8
                  ? 'var(--zg-danger)'
                  : 'var(--zg-text)',
            }"
          >
          ...
          <div>
            <button
              class="zcat-act"
              @click="alert('Loading wholesale profile for ' + c.name)"
            >
              View Ledger
            </button>
          </div>
      ...
      <div
        v-if="activeModuleTab === 'b2b_prices'"
        style="
          display: grid;
      ...
      >
        ...
        >
          ...
          >
            <button
              class="zcat-act"
              @click="alert('Edit Wholesale price levels')"
            >
              Edit pricing
            </button>
            <button class="zcat-act" @click="alert('Price list duplicated')">
              Duplicate
            </button>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          >
            <div class="zcat-field">
              ...
              <input
                ...
                v-model="formName"
                class="zcat-input"
                placeholder="e.g. Ramadan Gifting Set"
              />
            </div>

            <div class="zcat-field">
              <label class="zcat-label"
                >Component SKU Barcodes (comma separated) *</label
              >
              <input
                type="text"
                v-model="formSkus"
                class="zcat-input"
                placeholder="BH-OUD-50ML, ZL-HIJAB-BLU-OS"
                style="font-family: var(--zg-mono)"
              />
            </div>
          ...
          <div
            ...
            "
          >
            <button class="zen-btn-ghost" @click="formOpen = false">
              Cancel
            </button>
            <button class="zen-btn-primary" @click="saveBundleChanges">
              Save Changes
            </button>
          </div>
        </div>
        ...
        >
          ...
          >
            <h3
              ...
              "
            >
              New B2B Wholesaler Account
            </h3>
            <button
              @click="b2bFormOpen = false"
              style="
                background: transparent;
                border: none;
                font-size: 20px;
          ...
          >
            ...
            <div class="zcat-field">
              ...
              <input
                ...
                v-model="b2bEmail"
                class="zcat-input"
                placeholder="e.g. wholesale@alfuttaim.ae"
              />
            </div>
          ...
          <div
            ...
            "
          >
            <button class="zen-btn-ghost" @click="b2bFormOpen = false">
              Cancel
            </button>
            <button class="zen-btn-primary" @click="saveB2bAccount">
              Create Account
            </button>
          </div>
        </div>
...
const initialBundles = [
  {
    id: "BND-001",
    name: "Ramadan Gifting Set",
    skus: ["BH-OUD-50ML", "ZL-HIJAB-BLU-OS", "NC-ABAYA-BLK-54"],
    price: 849,
    compareAt: 1089,
    status: "active",
    markets: ["AE", "SA"],
  ...
  {
    id: "BND-002",
    name: "Desert Summer Pack",
    skus: ["DK-SNKR-WHT-42", "DK-BOOT-BRN-41"],
    price: 699,
    compareAt: 869,
    status: "active",
    markets: ["AE"],
  ...
  {
    id: "BND-003",
    name: "Men's Friday Essentials",
    skus: ["CC-TOBE-WHT-52", "UL-POLO-M-WHT", "UL-SHRT-NVY-M"],
    price: 489,
    compareAt: 598,
    status: "draft",
    markets: ["SA", "AE"],
  ...
  {
    id: "BND-004",
    name: "Oud & Bakhoor Collection",
    skus: ["BH-OUD-50ML", "BH-BKHR-250G", "HO-ATTAR-10ML"],
    price: 420,
    compareAt: 535,
    status: "active",
    markets: ["AE", "SA", "EG"],
  ...
  {
    id: "BND-005",
    name: "Abaya + Hijab Combo",
    skus: ["NC-ABAYA-BLK-54", "ZL-HIJAB-BLU-OS"],
    price: 589,
    compareAt: 698,
    status: "inactive",
    markets: ["AE"],
...
const initialB2bCustomers = [
  {
    ...
    outstanding: 142000,
    orders: 48,
    lastOrder: "Jun 2, 2025",
  },
  {
    id: "B2B-002",
    name: "Landmark Retail",
    type: "Retail Chain",
    market: "AE",
    status: "active",
    creditLimit: 250000,
    outstanding: 84000,
    orders: 31,
    lastOrder: "Jun 1, 2025",
  },
  {
    id: "B2B-003",
    name: "Alhokair Fashion Retail",
    type: "Retail Chain",
    market: "SA",
    status: "active",
    creditLimit: 380000,
...
const filteredBundles = computed(() => {
  return bundles.value.filter(
    (b) => statusFilter.value === "all" || b.status === statusFilter.value,
  );
});
...
const saveBundleChanges = () => {
  ...
  const finalSkus = formSkus.value
    .split(",")
    .map((s) => s.trim())
    .filter(Boolean);
