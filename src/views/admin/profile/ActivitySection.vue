...
const LOG = [
  ...
  {
    id: "e2",
    action: "Approved listing L-0441",
    module: "Marketplace",
    time: "2h ago",
    type: "action",
  },
  {
    id: "e3",
    action: "Resolved ticket TKT-4818",
    module: "Tickets",
    time: "3h ago",
    type: "action",
  },
  ...
  {
    id: "e5",
    action: "Processed payout PAY-4820",
    module: "Finance",
    time: "1d ago",
    type: "action",
  },
  ...
  {
    id: "e7",
    action: "Invited n.ibrahim@zucci.com",
...
const TYPE_COLOR = {
  auth: "var(--zg-accent)",
  action: "var(--zg-text-dim)",
  export: "oklch(0.82 0.14 215)",
};
</script>
  ...
  <div>
    ...
    <div class="up-card">
      ...
      >
        ...
        />
        <div style="flex: 1">
          <div style="font-size: 12.5px; color: var(--zg-text)">
            {{ e.action }}
          </div>
          <div
            style="
